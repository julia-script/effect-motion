# package-readmes Specification

## Purpose
Every publishable workspace package ships a README that renders as its npm landing page — a concise entry point (description, install with the effect peer dependency, a minimal working example, links to docs and source) rather than duplicating the docs site.
