...
export interface ThorVGCAPI {
	...
	_tvg_paint_set_mask_method(
		paint: number,
		target: number,
		method: number,
	): number;
	_tvg_paint_intersects(
		paint: number,
		x: number,
		y: number,
		w: number,
