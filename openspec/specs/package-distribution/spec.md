...
## Purpose
How the workspace packages are built and consumed: compiled ESM + type declarations under `dist/`, orchestrated by the monorepo task graph so any bundler can consume them without transpiling workspace source.
