...
## Purpose
Pure, sink-agnostic perspective projection math (view/perspective transforms, world-point and quad projection) shared by the renderer, usable without the Effect runtime and free of wall-clock/RNG so 2.5D scenes stay deterministic.
